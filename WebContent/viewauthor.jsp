		...
		<table class="table" id="authorsTable">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center"><button type="button" class="btn btn btn-primary" data-toggle="modal" data-target="#myModal1" href="editauthor.jsp?authorId=<%=author.getAuthorId()%>">Edit Author</button></td>
					<td><button type="button" class="btn btn-sm btn-danger" onclick="javascript:location.href='deleteAuthor.jsp?authorId=<%=author.getAuthorId()%>';">Delete Author</button>
				</tr>
				<%
					}
				%>
